...
set output      'B56.337G_22_fit_5.png'
set fit logfile 'B56.337G_22_fit_5.log'
...
set multiplot
  ...
  set size 0.80,0.80
    ...
    fit f(x) 'B56.337G_22_fit.tmp' u 1:2 via a, b
    set key title sprintf("V_{22}:  a_s=%.3f a_{11}",-b/a)

    plot [0:5][:] 'B56.337G_22.tmp' u 1:($2) w l ls 1 ti 'U_0(r)', f(x) ls 2 ti 'y = A_{fit} r + B_{fit}', 0 ls 3 ti ''
