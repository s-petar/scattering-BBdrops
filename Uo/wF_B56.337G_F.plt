...
set output      'wF_B56.337G_F.png'
set fit logfile 'wF_B56.337G_F.log'
...
plot [0:20][:] \
  'wF_B56.337G_11.txt' u 1:($2) w l ls 1 ti 'U_{11}(r)', \
  'wF_B56.337G_22.txt' u 1:($2) w l ls 2 ti 'U_{22}(r)', \
  'wF_B56.337G_12.txt' u 1:($2) w l ls 3 ti 'U_{12}(r)'
