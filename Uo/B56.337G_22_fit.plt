...
set output      'B56.337G_22_fit.png'
set fit logfile 'B56.337G_22_fit.log'
...
set multiplot
  ...
  set size 0.80,0.80
    ...
    plot [0:][:] 'B56.337G_22.tmp' u 1:($2) w l ls 1 ti 'U_0(r)', f(x) ls 2 ti 'y = A_{fit} r + B_{fit}', 0 ls 3 ti ''
