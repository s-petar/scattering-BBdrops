...
set output      'B56.337G_12_fit_20.png'
set fit logfile 'B56.337G_12_fit_20.log'
...
set multiplot
  ...
  set size 0.80,0.80
    ...
    plot [0:20][:] 'B56.337G_12.tmp' u 1:($2) w l ls 1 ti 'U_0(r)', f(x) ls 2 ti 'y = A_{fit} r + B_{fit}', 0 ls 3 ti ''
